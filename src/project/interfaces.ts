import { AccessEnums, ISkill, IUser, ProjectEnums } from '..'
import { Token } from '../dao/types'
import { LinkType, ProjectType, ProjectVisibilty, TaskStatus } from './enums'
import {
  GithubPR,
  IComment,
  Payout,
...
export interface IPayoutRequest
  extends Omit<Payout, 'payout_id' | 'payout_amount'> {
  payout_id?: string
